...
public class SpaceShip extends Polygon{
	...
	public static int[] polyXArray = {-26,28,-26,-10,-26};
	public static int[] polyYArray = {-30,0,30,0,-30};
	...
	public Rectangle getBounds(){
		...
		return new Rectangle((int) (getXCenter() - 28), (int) (getYCenter() - 30), getShipWidth(), getShipHeight());
	...
	public double getShipNoseX(){
		...
		return this.getXCenter() + Math.cos(rotationAngle) * 28;
	...
	public double getShipNoseY(){
		...
		return this.getYCenter() + Math.sin(rotationAngle) * 28;

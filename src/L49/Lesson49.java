...
public class Lesson49 extends JFrame
{
    ...
    public Lesson49()
    {
        ...
        brushBut = makeMeButtons("./src/L49/brush.png", 1);
        lineBut = makeMeButtons("./src/L49/Line.png", 2);
        ellipseBut = makeMeButtons("./src/L49/Ellipse.png", 3);
        rectBut = makeMeButtons("./src/L49/Rectangle.png", 4);

        // Make all the buttons in makeMeColorButton by passing the
        // button icon and true for stroke color or false for fill

        strokeBut = makeMeColorButton("./src/L49/Stroke.png", 5, true);
        fillBut = makeMeColorButton("./src/L49/Fill.png", 6, false);

...
public class Lesson48 extends JFrame
{
    ...
    public Lesson48()
    {
        ...
        brushBut = makeMeButtons("./src/L48/brush.png", 1);
        lineBut = makeMeButtons("./src/L48/Line.png", 2);
        ellipseBut = makeMeButtons("./src/L48/Ellipse.png", 3);
        rectBut = makeMeButtons("./src/L48/Rectangle.png", 4);

        // Make all the buttons in makeMeColorButton by passing the
        // button icon and true for stroke color or false for fill

        strokeBut = makeMeColorButton("./src/L48/Stroke.png", 5, true);
        fillBut = makeMeColorButton("./src/L48/Fill.png", 6, false);
